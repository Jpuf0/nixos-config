...
windowrule   = match:title ^(zen-beta — Sharing Indicator)$, float on
windowrule   = match:title ^(zen-beta — Sharing Indicator)$, move 0 0
windowrule   = match:title ^(Volume Control)$, size 700 450
windowrule   = match:title ^(Volume Control)$, move 40 55%
...
windowrule   = match:title ^(.*YouTube.*)$, opacity 1.0 override 1.0 override
windowrule   = match:title ^(Picture-in-Picture)$, pin on
windowrule   = match:initial_title ^(Discord Popout)$, float on
windowrule   = match:initial_title ^(Discord Popout)$, opacity 1.0 override 1.0 override
windowrule   = match:initial_title ^(Discord Popout)$, pin on
windowrule   = match:class (imv), float on
windowrule   = match:class (imv), center on
windowrule   = match:class (imv), size 1200 725
windowrule   = match:title ^(.*imv.*)$, opacity 1.0 override 1.0 override
windowrule   = match:class (mpv), float on
windowrule   = match:class (mpv), center on
windowrule   = match:title ^(.*mpv.*)$, opacity 1.0 override 1.0 override
windowrule   = match:class (Unity), opacity 1.0 override 1.0 override
windowrule   = match:class (zen-beta), opacity 1.0 override 1.0 override
windowrule   = match:class (mpv), size 1200 725
windowrule   = match:class ^(mpv)$, idle_inhibit focus
windowrule   = match:class ^(zen-beta)$, idle_inhibit fullscreen

windowrule   = match:title ^(float_kitty)$, float on
windowrule   = match:title ^(float_kitty)$, center on
windowrule   = match:title ^(float_kitty)$, size 950 600

windowrule   = match:class ^(pavucontrol)$, float on
windowrule   = match:class ^(SoundWireServer)$, float on
