...
stdenv.mkDerivation (finalAttrs: {
  ...
  src = fetchFromGitHub {
    ...
    hash = "sha256-CI68SdenoWRVlDag2orQrCAxbM5mQzUTVjC3xdBd4qQ=";
  };

  # src =
  #   if sourceFiles != ""
  #   then lib.cleanSource sourceFiles
  #   else
  #     fetchFromGitHub {
  #       owner = "Equicord";
  #       repo = "Equibop";
  ...
  nativeBuildInputs = [
    ...
    # seems to build with or without this hook, but I don't have the
  ...
  buildPhase = ''
    ...
    pnpm exec electron-builder \
        --dir -c.asarUnpack="**/*.node" \
        -c.electronDist=${electron.dist} -c.electronVersion=${electron.version}
  ...
  postFixup = ''
    ...
    --add-flags $out/opt/Equibop/resources/app.asar \
     ...
     --prefix LD_LIBRARY_PATH : ${lib.makeLibraryPath [pipewire libnotify]} \
